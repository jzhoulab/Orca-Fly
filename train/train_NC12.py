...
res = 125
modelstr = "NC12_res125.MP.woCentro"
...
if __name__ == "__main__":
    ...
    smooth_diag = np.load(f"{DATASET}/NC12_{res}bp_madmaxiter0_diag0_expected.tsv.npy")
    normmat = np.exp(
    ...
    t_val = Genomic2DFeatures(
        [f"{DATASET}/NC12_125bp_madmaxiter0.mcool::/resolutions/{res}"],
        [f"r{res}"],
        (mat_size, mat_size),
        cg=True,
        filt_tresh=0.3,
